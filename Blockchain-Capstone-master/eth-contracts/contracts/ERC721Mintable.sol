...
contract Pausable is Ownable {
    ...
    function setPaused(bool setting) public onlyOwner {
        _paused = setting;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        require(to != ownerOf(tokenId), "To address cannot be token owner");
        require(msg.sender == getOwner() || isApprovedForAll(getOwner(), msg.sender) == true, "Not approved");
